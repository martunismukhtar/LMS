...
export async function middleware(req: NextRequest) {
    const protectedRoutes = ['/users', '/settings', '/profile']; // Daftar rute yang dilindungi
...
export const config = {
    matcher: ['/users/:path*', '/settings/:path*', '/profile/:path*'], // Konfigurasi rute yang dilindungi
};
