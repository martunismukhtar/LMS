  ...
  return (
    <div className="bg-[#1c2434] text-white absolute left-0 top-0 z-9999 flex h-screen w-72 flex-col overflow-y-hidden duration-300 ease-linear dark:bg-boxdark sm:static translate-x-[-100%] sm:translate-x-0">
        ...
        <div className="flex items-center justify-start gap-2 px-8 py-7">
            <svg width="34px" height="34px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#f5f5f5"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <path fillRule="evenodd" clipRule="evenodd" d="M7 2C4.23858 2 2 4.23858 2 7V17C2 19.7614 4.23858 22 7 22H17C19.7614 22 22 19.7614 22 17V7C22 4.23858 19.7614 2 17 2H7ZM13 8C13 7.44772 12.5523 7 12 7C11.4477 7 11 7.44772 11 8V16C11 16.5523 11.4477 17 12 17C12.5523 17 13 16.5523 13 16V8ZM8 10C8.55228 10 9 10.4477 9 11V16C9 16.5523 8.55229 17 8 17C7.44772 17 7 16.5523 7 16V11C7 10.4477 7.44772 10 8 10ZM16 12C16.5523 12 17 12.4477 17 13V16C17 16.5523 16.5523 17 16 17C15.4477 17 15 16.5523 15 16V13C15 12.4477 15.4477 12 16 12Z" fill="#2453c2"></path> </g></svg>
            <h1 className="text-2xl font-bold">EduForge</h1>
        </div>
        {/* end side header */}
        <div className="flex flex-col static ">
            <h2 className="mt-4 ml-4 text-lg font-medium">Menu : {pathname}</h2>
            <nav className="px-4 py-2 ">
                <div>
                <ul className="flex flex-col gap-1.5">
                    <li>
                        <Link href="#" className="group relative flex bg-dark items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-color-dark1 duration-300 ease-in-out hover:bg-color-dark dark:hover:bg-meta-4">Dashboard</Link>
                    </li>
                    <li>
                        <div className="group relative flex bg-dark items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-color-dark1 duration-300 ease-in-out hover:bg-color-dark dark:hover:bg-meta-4 cursor-pointer"   
                            onClick={() => setOpenMenu(isOpenMenu === "data" ? null : "data")}                     
                        >
                        ...
                        <ul className={`list-none ${isOpenMenu==='data' ? 'block opacity-100' : 'hidden opacity-0'} transition-all duration-300 ease-in-out mb-5.5 mt-4 flex flex-col gap-2.5 pl-6`}>
                            <li>
                                <Link href="/admin/category" className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-color-dark2 duration-300 ease-in-out hover:text-white ${selected==='category' ? 'text-primary' : ''}`}>
                                Category
                                </Link>
                                <Link href="/admin/category" className="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-color-dark2 duration-300 ease-in-out hover:text-white">
                                Course
                                </Link>
                                </li>                            
                        </ul>
                    ...
                    <li>
                        <div className="group relative flex bg-dark items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-color-dark1 duration-300 ease-in-out hover:bg-color-dark dark:hover:bg-meta-4 cursor-pointer"   
                            onClick={() => setOpenMenu(isOpenMenu === "user" ? null : "user")}                     
                        >
                        <svg className="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clipPath="url(#clip0_130_9728)">
                                <path d="M3.45928 0.984375H1.6874C1.04053 0.984375 0.478027 1.51875 0.478027 2.19375V3.96563C0.478027 4.6125 1.0124 5.175 1.6874 5.175H3.45928C4.10615 5.175 4.66865 4.64063 4.66865 3.96563V2.16562C4.64053 1.51875 4.10615 0.984375 3.45928 0.984375ZM3.3749 3.88125H1.77178V2.25H3.3749V3.88125Z" fill=""></path>
                        ...
                        <ul className={`list-none ${isOpenMenu==='user' ? 'block opacity-100' : 'hidden opacity-0'} transition-all duration-300 ease-in-out mb-5.5 mt-4 flex flex-col gap-2.5 pl-6`}>
                            <li>
                                <Link href="/admin/category" className="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-color-dark2 duration-300 ease-in-out hover:text-white">
                                Category
                                </Link>
